...
namespace Base_Tools45
{
    ...
    public static class SymTbl
    {
        ...
        AddToCurrentSpace(Entity ent, Database db)
        {
            ...
            {
                BaseObjs.writeDebug(ex.Message + " SymTbl.cs: line: 62");
            }
            return objId;
        }
        ...
        /// use a CompBldr object.
        /// </summary>
        /// <param name="ents">Entities that have not yet been added to the database</param>
        /// <param name="db">Database to add to</param>
        public static void
        AddToCurrentSpace(DBObjectCollection ents, Database db)
        {
            try
            {
                using (Transaction tr = BaseObjs.startTransactionDb())
            ...
            {
                BaseObjs.writeDebug(ex.Message + " SymTbl.cs: line: 92");
            }
        }
        ...
        AddToCurrentSpaceAndClose(Entity ent, Database db)
        {
            ...
            try
            {
                using (Transaction tr = BaseObjs.startTransactionDb())
                {
                    objId = AddToCurrentSpace(ent, db);
                    tr.Commit();
                }
            }
            catch (System.Exception ex)
            {
                BaseObjs.writeDebug(ex.Message + " SymTbl.cs: line: 120");
            }
        ...
        /// use a CompBldr object.  This version will Start and Commit a Transaction.
        /// </summary>
        /// <param name="ents">An entities which are not yet in the database</param>
        /// <param name="db">The Database to add it to</param>
        /// <returns>The ObjectId of the newly added Entity</returns>
        public static void
        ...
        /// <param name="symName">Name of the symbol</param>
        /// <param name="db">Specific database we are looking at</param>
        ...
        SymbolTableRecExists(System.Type classType, string symName, Database db)
        {
            ...
            {
                BaseObjs.writeDebug(ex.Message + " SymTbl.cs: line: 308");
            }
