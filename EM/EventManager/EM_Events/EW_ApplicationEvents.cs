...
{
	/// <summary>
	/// EW_ApplicationEvents.
	/// </summary>
	public class EW_ApplicationEvents
	{
		public EW_ApplicationEvents()
		{
			m_bDone = false;
			Do();
		}
       ...
       BaseObjs.writeDebug(ex.Message + " EW_ApplicationEvents.cs: line: 54");
   }
		}
       ...
       BaseObjs.writeDebug(ex.Message + " EW_ApplicationEvents.cs: line: 75");
   }
	...
	}	// end of class EW_ApplicationEvents
}
